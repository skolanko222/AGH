...
{
	this->SetClientSize(this->FromDIP(wxSize(777, 497)));
	...
	WxEdit_x0 = new wxTextCtrl( this, wxID_ANY, _("-1.0"), wxDefaultPosition, this->FromDIP(wxSize(50, -1)), 0 );
	...
	WxEdit_y0 = new wxTextCtrl( this, wxID_ANY, _("-2.0"), wxDefaultPosition, this->FromDIP(wxSize(50, -1)), 0 );
	...
	WxEdit_x1 = new wxTextCtrl( this, wxID_ANY, _("1.0"), wxDefaultPosition, this->FromDIP(wxSize(50,-1)), 0 );
	...
	WxEdit_y1 = new wxTextCtrl( this, wxID_ANY, _("2.0"), wxDefaultPosition, this->FromDIP(wxSize(50,-1)), 0 );
	...
	WxStaticText_alpha->SetMinSize(this->FromDIP(wxSize(23,-1)));
	...
	WxEdit_dX = new wxTextCtrl( this, wxID_ANY, _("0.0"), wxDefaultPosition, this->FromDIP(wxSize(50,-1)), 0 );
	...
	WxEdit_dY = new wxTextCtrl( this, wxID_ANY, _("0.0"), wxDefaultPosition, this->FromDIP(wxSize(50,-1)), 0 );
	...
	WxEdit_x_start = new wxTextCtrl( this, wxID_ANY, _("-1.0"), wxDefaultPosition, this->FromDIP(wxSize(50,-1)), 0 );
	...
	WxEdit_x_stop = new wxTextCtrl( this, wxID_ANY, _("2.0"), wxDefaultPosition, this->FromDIP(wxSize(50,-1)), 0 );
