...
MyFrame::MyFrame() : wxFrame(NULL, wxID_ANY, "Demo 07")
{
	...
	WxChoice1 = new wxChoice(this, wxID_ANY, wxPoint(447, 21), wxSize(234, 32), arrayStringFor_WxChoice1, 0, wxDefaultValidator, _("WxChoice1"));
...
/*
	wxArrayString SystemFonts = wxFontEnumerator::GetFacenames(); // ---> #include <wx/fontenum.h>
	WxChoice1 = new wxChoice(this, wxID_ANY, wxPoint(447, 21), wxSize(234, 23), SystemFonts, 0, wxDefaultValidator, _("WxChoice1"));
*/
...
void MyFrame::Form_Paint(wxPaintEvent& e)
{
	...
	MyDC->DrawText("Przyk�adowy tekst (���󥹌����������)", 20, 70);
