...
plt.savefig("plots/VxVy.png",bbox_inches='tight',transparent=False)
...
plt.savefig("plots/C_Xsr.png",bbox_inches='tight',transparent=False)
...
plt.savefig("plots/U.png",bbox_inches='tight',transparent=False)
