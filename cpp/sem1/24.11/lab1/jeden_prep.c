...
# 38 "jeden.c"
 ...
 printf("---- PRINTF ------ \n");
 printf("------------------ \n");
 printf("out1 %f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 printf("out2 %g +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 printf("out3 %4.2f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 printf("out4 %6.2f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 printf("out5 %-6.2f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 printf("out6 %-6.*f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781,3);
 printf("------------------ \n");
 printf("out7 %0.10f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 printf("out8 %-10.5f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 printf("out9 %10.5f +\n",(float)3.14159265358979323846264338327950288419716939937510582097494459230781);
 ...
 printf("out11 %10.15lf +\n",(double)3.14159265358979323846264338327950288419716939937510582097494459230781);

 printf("------------------ \n");
 printf("out12 %10.25f +\n",(float)1.000000001);
 printf("out13 %10.25f +\n",1.000000001f);
 printf("out13 %10.25lf +\n",(double)1.000000001);
 printf("out14 %10.25Lf +\n",(long double)1.0000000000001f);
 printf("out15 %10.25Lf +\n",(long double)1.0000000000001);
 printf("out16 %10.25Lf +\n",1.0000000000001L);

 printf("------------------ \n");
 printf("out17 %d +\n",(int)3.14159265358979323846264338327950288419716939937510582097494459230781*200);
 printf("out18 %d +\n",(int)(3.14159265358979323846264338327950288419716939937510582097494459230781*200));
 printf("out18 %2d +\n",(int)(3.14159265358979323846264338327950288419716939937510582097494459230781*200));
 printf("out19 %14d +\n",(int)(3.14159265358979323846264338327950288419716939937510582097494459230781*200));
 printf("out20 %-14d +\n",(int)(3.14159265358979323846264338327950288419716939937510582097494459230781*200));
 ...
 printf("out22 %04d +\n",(int)(3.14159265358979323846264338327950288419716939937510582097494459230781*200));
 printf("out23 %12.9d +\n",(int)(3.14159265358979323846264338327950288419716939937510582097494459230781*200));
 printf("out24 %*d +\n",(int)(3.14159265358979323846264338327950288419716939937510582097494459230781*200), 5);
